...
from asvspoof21.experiment.as21_experiment import AS21GMMExperiment, AS21GMM2Path2StepExperiment, AS21GMM2PathExperiment
from asvspoof21.model.as_gmm import DiagGMMLayer
...
class GMMResNetPath(nn.Module):
    def __init__(self, gmm) -> None:
        ...
        self.gmm_layer = DiagGMMLayer(gmm, requires_grad=False)
...
if __name__ == '__main__':
    ...
    exp_param[
        'gmm_file'] = '/home/labuser/ssd/lzc/ASVspoof2021exp/GMM_D_aug2_rb4_LFCC21NN_20240630_204210/ASVspoof2019_GMM_LFCC21NN_LA_512.h5'
    # exp_param[
    #     'gmm_spoof_file'] = '/home/labuser/ssd/lzc/ASVspoof/ASVspoof2021exp/GMM_D_aug2_rb4_{}/ASVspoof2019_GMM_{}_{}_512_spoof.h5'.format(
    #     feature_type, feature_type, access_type)
    # exp_param[
    #     'gmm_bonafide_file'] = '/home/labuser/ssd/lzc/ASVspoof/ASVspoof2021exp/GMM_D_aug2_rb4_{}/ASVspoof2019_GMM_{}_{}_512_bonafide.h5'.format(
    #     feature_type, feature_type, access_type)
