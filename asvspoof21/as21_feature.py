...
from asvspoof21.util.as_util import clear_dir

if os.name == 'posix':
    data_path_19 = '/home/labuser/lzc/ASVspoof/ASVspoof2019/DS_10283_3336'
    feat_path_19 = '/home/labuser/ssd/lzc/ASVspoof/ASVspoof2019feat'
    data_path_21 = '/home/labuser/lzc/ASVspoof/ASVspoof2021'
...
def extract_one(utterance, wave_path, feat_path, feature_type, access_type, dataset, aug_methods):
    ...
    for aug_method in aug_methods:
        ...
        with h5py.File(feat_file, 'w') as f:
            feature = feature.squeeze(0).detach().numpy()
...
if __name__ == '__main__':
    ...
    feature_type = 'LFCC21NN'  # LFCC21NN_VAD'  # LFCC21NN
    aug_methods = ['Original', 'RB4']  # 'Original', 'RB4'
